...
export const GAS_BF_PRODUCTS: GasFireProduct[] = [
  // ── Gazco BF ───────────────────────────────────
  // Riva2 500HL Slimline — Remote only, no trim, Programmable Remote upgrade available
  {
    brand: "Gazco",
    name: "Riva2 500HL BF",
...
export const GAS_CF_PRODUCTS: GasFireProduct[] = [
  // ── Gazco CF ───────────────────────────────────
  // Riva2 400 — Remote only, no trim, Programmable Remote upgrade available
  {
    brand: "Gazco",
    name: "Riva2 400 CF",
...
export const GAS_STOVE_PRODUCTS: GasStoveProduct[] = [
  ...
  // Conventional Flue
  { brand: "Charlton & Jenrick", name: "Paragon Edge Conventional Flue NG", fuel: "Natural Gas (CF)", priceExVat: 1499.17 },
  { brand: "Charlton & Jenrick", name: "Paragon Edge Conventional Flue LPG", fuel: "LPG (CF)", priceExVat: 1499.17 },
  { brand: "Charlton & Jenrick", name: "Paragon Edge CF NG with Vermiculite Liners", fuel: "Natural Gas (CF)", priceExVat: 1457.50 },
  // Balanced Flue
  { brand: "Charlton & Jenrick", name: "Paragon Edge BF Gas Stove NG (With Snorkel Flue)", fuel: "Natural Gas (BF)", priceExVat: 1974.17 },
  { brand: "Charlton & Jenrick", name: "Paragon Edge BF Gas Stove NG (With Top Vent Kit)", fuel: "Natural Gas (BF)", priceExVat: 1974.17 },
  { brand: "Charlton & Jenrick", name: "Paragon Edge 3-Sided BF Gas Stove NG (With Snorkel Flue)", fuel: "Natural Gas (BF)", priceExVat: 2190.83 },
  { brand: "Charlton & Jenrick", name: "Paragon Edge 3-Sided BF Gas Stove NG (With Top Vent Kit)", fuel: "Natural Gas (BF)", priceExVat: 2190.83 },
];
